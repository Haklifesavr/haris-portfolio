            ...
            <Grid item xs={12} sm={10} md={8} lg={7}>
                <Box ref={ref}>
                    ...
                    <Typography
                        ...
                        I specialize in creating top-notch web applications tailored to your business needs using cutting-edge technologies and best design practices.
                    </Typography>
                    ...
                    <Box
                        ...
                        <a href="https://drive.google.com/file/d/1IcWfi9mCDlijy8lCO3cCSwgt2DKr7gRZ/view?usp=drivesdk" rel="noreferrer" target='_blank'>
                            <Button
                                className='b2'
                                sx={{
                                    ...btnStyles,
